#!/usr/bin/env python3
"""
Splatline Video Splat Viewer — View all video frames as splats in SuperSplat.

Takes the PLY files generated by run_video_3d.py and opens them in the
SuperSplat editor. Two modes:
...
def main():
    ...
    print("=" * 60)
    print("SPLATLINE VIDEO SPLAT VIEWER (SuperSplat Editor)")
    print("=" * 60)
